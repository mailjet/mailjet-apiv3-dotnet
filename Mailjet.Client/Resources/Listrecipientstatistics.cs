...
{
    public static class Listrecipientstatistics
    {
        public static readonly ResourceInfo Resource = new ResourceInfo("listrecipientstatistics");
        ...
        public const string ListRecipient = "ListRecipient";
        ...
        public const string MaxUnsubscribedAt = "MaxUnsubscribedAt";
        public const string MinLastActivityAt = "MinLastActivityAt";
        public const string MinUnsubscribedAt = "MinUnsubscribedAt";
