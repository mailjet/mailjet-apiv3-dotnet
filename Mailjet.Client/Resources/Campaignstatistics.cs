namespace Mailjet.Client.Resources
{
    ...
    {
        public static readonly ResourceInfo Resource = new ResourceInfo("campaignstatistics");
        ...
        public const string CampaignIsStarred = "CampaignIsStarred";
        public const string CampaignSendStartAt = "CampaignSendStartAt";
        public const string CampaignSubject = "CampaignSubject";
        ...
        public const string GroupAX = "GroupAX";
