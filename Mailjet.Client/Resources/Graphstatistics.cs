namespace Mailjet.Client.Resources
{
    ...
    {
        public static readonly ResourceInfo Resource = new ResourceInfo("graphstatistics");
        ...
        public const string RefTimestamp = "RefTimestamp";
        public const string SendtimeStart = "SendtimeStart";
        ...
        public const string RefTimeStampOldFormat = "RefTimeStampOldFormat";
        ...
        private const string DeferredCount = "DeferredCount";
    }
}
