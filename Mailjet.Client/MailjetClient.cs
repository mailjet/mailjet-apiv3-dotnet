...
public class MailjetClient : IMailjetClient
{
    ...
    public async Task<MailjetResponse> PostAsync(MailjetRequest request)
    {
        ...
        var output = request.Body.ToJsonString();
        HttpContent contentPost = new StringContent(output, System.Text.Encoding.UTF8, MailjetConstants.JsonMediaType);
    ...
    public async Task<MailjetResponse> PutAsync(MailjetRequest request)
    {
        ...
        var output = request.Body.ToJsonString();
        HttpContent contentPut = new StringContent(output, System.Text.Encoding.UTF8, MailjetConstants.JsonMediaType);
    ...
    [System.Diagnostics.CodeAnalysis.MemberNotNull(nameof(_httpClient))]
    ...
    {
        return SendTransactionalEmailsAsync([transactionalEmail], isSandboxMode, advanceErrorHandling);
    }
    ...
    public async Task<TransactionalEmailResponse> SendTransactionalEmailsAsync(IEnumerable<TransactionalEmail> transactionalEmails, bool isSandboxMode = false, bool advanceErrorHandling = true)
    {
        ...
        var serializedRequest = JsonSerializer.SerializeToNode(request, SerializerOptions)?.AsObject() ?? new JsonObject();
        ...
        TransactionalEmailResponse? result = clientResponse.Content.Deserialize<TransactionalEmailResponse>(SerializerOptions);
        ...
        return result ?? new TransactionalEmailResponse();
    }
}
